...
| --- | --- | --- |
| `hello` | `vm`, `llvm`, `hybrid` | small runnable entrypoint, bundled Foundation import, and VM-side struct printing |
...
- a real native callback path, open [Callbacks](/docs/appendix/examples/callbacks)
- a mixed runtime/native example, open [Hybrid Roundtrip](/docs/appendix/examples/hybrid-roundtrip)
- the strongest FFI/autobinding proof, open [Sokol Triangle](/docs/appendix/examples/sokol-triangle)
